...
\033[1;97m•••••••••••••••••••••••••••••••••••••••••••••••      
\033[1;91m➣ \033[1;96mTHANKS FOR USE MY COMMANDS ..
\033[1;97m•••••••••••••••••••••••••••••••••••••••••••••••      
\033[1;91m➣ DEVOLPER     :       ARADIN
\033[1;92m➣ FACEBOOK     :     Illıllı Ɩɱtɩʌʑ Illıllı 
\033[1;97m➣ GITHUB       :         ARADIN110
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:THE ARADIN
	    time.sleep(2)
            loop = 'false'
        else:
...
def action():
    ...
    jalan ("\033[1;93m[+] Not Show IDS Use Aroplane Flight Mod...")
